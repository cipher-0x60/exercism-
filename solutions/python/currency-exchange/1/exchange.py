...
def exchangeable_value(budget, exchange_rate, spread, denomination):
    ...
    """
    final_spread = spread / 100                                # 0.1
    final_exchange_rate = exchange_rate * (final_spread + 1)   # 1.32
    final_exchange = budget / final_exchange_rate              # 96.4015
    bill_count = final_exchange // denomination                # 19
    result = bill_count * denomination                         # 95
    return result
